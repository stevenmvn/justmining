<nav class="nav">
    ...
    <ul class="nav__menu">
        ...
        <li class="nav__item"><a href="https://github.com/stevenmvn/justmining" class="btn btn__img btn--primary"><img src="{{ asset('images/github.svg') }}" alt="Icone github">Github du projet</a></li>
    </ul>
</nav>